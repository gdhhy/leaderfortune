...
<head>
    <meta charset="utf-8"/>
    <title>积分充值明细 - ${short_title}</title>
    ...
    <script type="text/javascript">
        jQuery(function ($) {
            ...
            var url = "/deposit.jspx?memberNo=" + memberNo;
            ...
            //.wrap("<div class='dataTables_borderWrap' />")   //if you are applying horizontal scrolling (sScrollX)
                .DataTable({
                    ...
                    "columns": [
                        ...
                        {"data": "积分", "sClass": "center"},
                        {"data": "充值时间", "sClass": "center"}
                    ],
                    ...
                    'columnDefs': [
                        ...
                        {"orderable": false, "targets": 8, title: '积分'},
                        {"orderable": false, "targets": 9, title: '充值时间'}

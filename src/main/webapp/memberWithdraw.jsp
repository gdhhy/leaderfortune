...
<head>
    ...
    <script type="text/javascript">
        jQuery(function ($) {
            ...
            var url = "/memberWithdraw.jspx?memberNo=" + memberNo;
            ...
            //充值金额,充值手续费,取现类型,取现银行卡号,订单号,状态,时间
            ...
            //.wrap("<div class='dataTables_borderWrap' />")   //if you are applying horizontal scrolling (sScrollX)
                .DataTable({
                    ...
                    'columnDefs': [
                        {"orderable": false, className: 'text-center', "targets": 0, title: '订单号'},
                        {"orderable": false, className: 'text-center', "targets": 1, title: '取现银行卡号'},
                        {"orderable": false, className: 'text-center', "targets": 2, title: '提现金额'},
                        {"orderable": false, className: 'text-center', "targets": 3, title: '提现手续费'},
                        {"orderable": false, className: 'text-center', "targets": 4, title: '取现类型'},
                        {"orderable": false, className: 'text-center', 'targets': 5, title: '状态'},
                        {"orderable": false, className: 'text-center', 'targets': 6, title: '时间'}
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <div class="table-header">
                                    姓名：<span id="realName"></span>，身份证号：<span id="idCard"></span> ，提现记录
